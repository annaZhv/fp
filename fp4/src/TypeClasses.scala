object TypeClasses {
  ...
  def main(args: Array[String]): Unit = {
    println("Вопрос времени наоборот: " + testReversableString("Вопрос времени"))
    println("13 + 21 = " + testSmashInt(13,21))
    println("3.3*7.0 = " + testSmashDouble(3.3,7.0))
    println("Конкатенация строк (С,горел) = " + testSmashString("С", "горел"))
  }
